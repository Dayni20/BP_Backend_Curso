...
{
    public class CuentaCorriente : CuentaBancaria3

    {
        public string TasaInteres { get; set; }


        public CuentaCorriente(string propietario, string numero, decimal saldo, string tasaInteres)//el constructor se va a manejar desde esta clase hija
        {
